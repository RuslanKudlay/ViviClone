...
window.Modernizr = function (a, b, c) {
    ...
    B = E(A, "undefined") || E(A.call, "undefined") ? function (a, b) {
        ...
        return C("background:url(//),url(//),red url(//)"), /(url\s*\(.*?){3}/.test(j.background)
...
var PageTransitions = (function ($) {
    ...
    function initScrollEvents() {
        ...
        if (jQuery(window).width() <= 768) {
            jQuery("#pt-main").on("swipedown", function (event) {
                console.log("swipedown was fired");
                prevPage(PTSettings.b_effect)
            })
            jQuery("#pt-main").on("swipeup", function (event) {
                console.log("swipedup was fired");
                nextPage(PTSettings.f_effect)
            })
        }
    }
    ...
    function toPage(animation, page) {
        ...
        console.log("ToPage meth (4161) " + page);
        page = page - 1;
        isAnimating = !0;
        var $currPage = $pages.eq(current);
        if (current < page) {
    ...
    function onEndAnimation($outpage, $inpage) {
        ...
        console.log(jQuery(".pt-page-current").attr('id'));
    }

    function paginationShowCurrentItem() {
