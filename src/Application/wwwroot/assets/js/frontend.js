jQuery(document).ready(function ($) {
    ...
    $('body').on('click','.click-grid', function(e) {
    ...
    $('body').on('click','.click-list', function(e) {
    ...
    $('body').on('click','.close-side-top', function(e) {
    ...
    $(window).scroll(function () {
        ...
        var header_bottom_h = $('.header-bottom').outerHeight();
  
        if ($(window).width() > 1024) {
            if (scroll >= header_bottom_h) {
